...
const loadAlbumData= async(e) =>
{
  ...
  try {
    ...
    {
      setAlbumData(respone.data.albums);
    }
    else
    {
...
useEffect(()=>
{
  ...
  <div className='grid place-items-center min-h-[80vh]'>
    ...
    <form  onSubmit={ onSubmitHandler}className='fex flex-col items-start gap-8 text-gray-600'>
...
<br />
 ...
 <div className='flex flex-col gap-2.5'>
    <p>Album</p>
    <select  onChange= {(e)=> setAlbum(e.target.value)} defaulValue={album}  className='bg-transparent outline-green-600 border-2 border-gray-400 p-2.5 w-[150px]' >
